make: main.cpp
	clang++ -dynamiclib -undefined suppress -Iinclude src/imu.cpp src/switch_controller.cpp src/rumble.cpp src/joycon_report.cpp -I /opt/homebrew/Cellar/hidapi/0.14.0/include -std=c++11 -o libjoycon.dylib
